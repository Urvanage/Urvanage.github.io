...
✉️ patrickabc456@gmail.com · [GitHub](https://github.com/Urvanage)
...
## 🎓 Education
- **Sungkyunkwan University (SKKU)** · B.S. Computer Science and Engineering · 2020 – Feb 2026.  
...
### 8. **Conty AI Test Automation Agent** (Python · RAG · ADB)
Developed an AI-based testing agent that generates and executes mobile app test scenarios from natural language commands.  
The system retrieves relevant manual information using a vector database and performs automated UI interactions through ADB, while verifying results via screenshot analysis.  
🔗 https://github.com/Urvanage/MCP_Project
